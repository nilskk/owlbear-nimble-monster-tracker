    ...
    try {
        ...
        if (jsonUrl.value.trim()) {
            try {
                ...
                // Transform old nimble.monster URL format to new format
                if (url.startsWith('https://nimble.monster/monsters?id=')) {
                    url = url.replace('https://nimble.monster/monsters?id=', 'https://nimble.monster/m/')
                }
